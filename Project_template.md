...
Критическая пометка: Dockerfile для REPL-запуска подготовлен в `Task5/Dockerfile`, но `docker-compose.yml`, сохраненные 10 скриншотов и ссылка на PR пока не добавлены.
